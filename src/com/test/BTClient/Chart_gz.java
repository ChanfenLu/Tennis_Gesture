...
public class Chart_gz extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.chart_gz);
        ActionBar actionBar = getActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);

        
        Intent intent = getIntent();
        int[] num = intent.getIntArrayExtra("extra_data_6");
        
        LineChart mLineChart = (LineChart) findViewById(R.id.chartline_gz);
        //制作7个数据点（沿x坐标）
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		  switch (item.getItemId()) {
	        case android.R.id.home:
	        	Intent intent = new Intent(Chart_gz.this, BTClient.class);
	        	intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
	        	startActivity(intent);
	        	overridePendingTransition(R.anim.push_left_in,R.anim.push_left_out);
	        	break;
	        case R.id.example_icon:
	       	    Intent intent1 = new Intent(Chart_gz.this, ExamplePlay.class);
	        ...
	        case R.id.search:
	        	...
	        	break;
	        case R.id.about:
	        	Intent intent2 = new Intent(Chart_gz.this, About.class);
